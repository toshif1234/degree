...
$con = $link;
	...
	if(isset($_POST["export"])) {
		...
		$query = "select * from ia_marks2 where  branch=\"" . $branch . "\" and sem=\"" . $sem . "\" and sub=\"" . $sub . "\" ;" ;
		...
		// SQL query to fetch data from our table
		$query = "select * from ia_marks2 where  branch=\"" . $branch . "\" and sem=\"" . $sem . "\" and sub=\"" . $sub . "\" and sec=\"" . $sec . "\" ;" ;
		}
		// Result
