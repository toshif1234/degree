...
$q = 'select * from feedback_response where usn="' . $_SESSION['username'] . '" and feedback_name="Feedback on course"';
$q_r = $link->query($q);
...
$gen = 'select * from feedback_all where feedback_name="Feedback on course"';
$r_gen = mysqli_fetch_assoc($link->query($gen));

?>


<form action="fac_update_cur_stud.php" method="post">
    <div class="font-weight-bolder" style='height: 3em;'>
        <h3>Feedback on Course</h3>
    </div>
