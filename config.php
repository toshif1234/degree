...
// $link = mysqli_connect('localhost', 'root', '', 'erpalvasdev');
// $link = mysqli_connect('saw-erp.in', 'devuser_erpalvasdev', 'Hype#123', 'erpalvasdev');
// if (isset($_SESSION['is_archive']) && $_SESSION['is_archive'] == 1) {
//   $username = 'archive_archive' . $_SESSION['year1'] . $_SESSION['year2'];
//   $db = 'use archive' . $_SESSION['year1'] . $_SESSION['year2'];
//   $link =mysqli_connect('localhost', $username, 'Hype#123');
//   $link->query($db);
// }
// else{
