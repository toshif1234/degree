...
$q1 = "select distinct sem from exam_arrear_details where faculty_name='$use'";
...
<script>
    function myfunc()
    {
        ...
        if(a=="")
        {
            document.getElementById("message1").innerHTML="  **Please Select Semester";
            return false;
        }
    }
    </script>
 ...
 <br>
<form action="../external_seat_allotment/addarrview2.php" method="POST" class="row g-3 " onsubmit="return myfunc()">
    <div class="row">
        <div class="col-md-4">
