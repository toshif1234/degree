...
$q1 = "select distinct ps_code from exam_arrear_details where sem= $sem and faculty_name='$use'";
...
<form action="../external_seat_allotment/session_for_addview3.php" method="POST" class="row g-3 " onsubmit="return myfunc()">
    <div class="row">
        <div class="col-md-4">
