...
<div class="container">
    ...
    $que = "select * from students s, parents_details p, puc_details pu, sslc_details ss where s.adm_no = ss.adm_no and ss.adm_no = pu.adm_no and pu.adm_no = p.adm_no and batch=\"" . $_SESSION['batch']  . "\" and branch=\"" . $_SESSION['branch'] . "\"";
                        ...
                        <div class="row">
                            <div class="col col-12 col-md-12 col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="sslc_percentage" class="form-control" id="sslc_percentage" value="<?php echo $row['sslc_percentage']; ?>">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col col-12 col-md-12 col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="puc_percentage" class="form-control" id="puc_percentage" value="<?php echo $row["puc_percentage"] ?>">
                                </div>
                            </div>
                        </div>
                        <div class="row">
