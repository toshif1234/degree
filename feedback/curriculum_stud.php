...
$q = 'select * from feedback_response where usn="' . $_SESSION['username'] . '" and feedback_name="Curriculum Feedback"';
$q_r = $link->query($q);
...
<form action="update_cur_stud.php" method="post">
    <div class="font-weight-bolder" style='height: 3em;'>
        <h3>Feedback on Curriculum</h3>
    </div>
