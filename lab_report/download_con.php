...
if ($_POST['ia'] == 4) {
  $sheet->getCell('A3')->setValue('SEMESTER ' . $_POST['sem'] . $_POST['sec'] . ', CONSOLIDATED IA REPORT');
  ...
  $q = 'select distinct sub from marks where sem = "' . $_POST['sem'] . '" and branch = "' . $_POST['dept'] . '" and sec = "' . $_POST['sec'] . '" order by sub';
  $result = $link->query($q);
  ...
  foreach ($result1 as $r1) {
    ...
    foreach ($result as $r2) {
      $q_sub_marks = 'select a.ia_avg, b.att_avg from marks a, attendance_average b where a.usn = "' . $r1['usn'] . '" and a.branch = "' . $_POST['dept'] . '" and a.sub = "' . $r2['sub'] . '" and a.usn = b.usn';
      $q_ass_marks = 'select * from assignment_marks where usn = "' . $r1['usn'] . '" and branch = "' . $_POST['dept'] . '" and sub_name = "' . $r2['sub'] . '"';
      echo $q_sub_marks;
      ...
      if (mysqli_num_rows($result_sub_marks) == 0) {
        ...
        $r_ass22 = mysqli_fetch_assoc($result_ass_marks);
        $div = mysqli_fetch_assoc($link->query('select count(*) as cou from add_assignment where sub_name = "' . $r2['sub'] . '"'))['cou'];
        if($div == 0){
          $div = 1;
        }
        $ass_marks = ceil(($r_ass22['a1'] ?? 0) + ($r_ass22['a2'] ?? 0) + ($r_ass22['a3'] ?? 0) + ($r_ass22['a4'] ?? 0) + ($r_ass22['a5'] ?? 0)/$div); 
        $count_sub += 1;
        $sheet->getCell(chr($cha) . $co)->setValue($r22["ia_avg"] + $ass_marks);
        $cha += 1;
  ...
  // $cha = ord('D');
  // foreach ($result as $r) {
  //   $q3 = 'select COUNT(ia_avg) as mark from marks where sem = "' . $_POST['sem'] . '" and branch = "' . $_POST['dept'] . '" and ia_avg<=12 and sub="' . $r['sub'] . '" and sec = "' . $_POST['sec'] . '"';
  //   // echo $q3;
  //   $result3 = $link->query($q3);
  //   $r5 = mysqli_fetch_assoc($result3);
  //   // print_r($r5);
  ...
  //   $q3 = 'select COUNT(ia_avg) as mark from marks where sem = "' . $_POST['sem'] . '" and branch = "' . $_POST['dept'] . '" and ia_avg BETWEEN 12 AND 19  and sub="' . $r['sub'] . '" and sec = "' . $_POST['sec'] . '"';
  //   // echo $q3;
  //   $result3 = $link->query($q3);
  //   $r5 = mysqli_fetch_assoc($result3);
  //   // print_r($r5);
  ...
  //   $q3 = 'select COUNT(ia_avg) as mark from marks where sem = "' . $_POST['sem'] . '" and branch = "' . $_POST['dept'] . '" and ia_avg>=20 and sub="' . $r['sub'] . '" and sec = "' . $_POST['sec'] . '"';
  //   // echo $q3;
  //   $result3 = $link->query($q3);
  //   $r5 = mysqli_fetch_assoc($result3);
  //   // print_r($r5);
  ...
  //   $q3 = 'select COUNT(ia_avg) as mark from marks where sem = "' . $_POST['sem'] . '" and branch = "' . $_POST['dept'] . '" and ia_avg=30 and sub="' . $r['sub'] . '" and sec = "' . $_POST['sec'] . '"';
  //   // echo $q3;
  //   $result3 = $link->query($q3);
  //   $r5 = mysqli_fetch_assoc($result3);
  //   // print_r($r5);
  ...
  // $cha = ord('D');
  // foreach ($result as $r) {
  //   $q3 = 'select COUNT(ia_avg) as mark from marks where sem = "' . $_POST['sem'] . '" and branch = "' . $_POST['dept'] . '" and ia_avg>=14 and sub="' . $r['sub'] . '" and sec = "' . $_POST['sec'] . '"';
  //   // echo $q3;
  //   $result3 = $link->query($q3);
  //   $r5 = mysqli_fetch_assoc($result3);
  //   // print_r($r5);
  ...
  $q = 'select distinct sub from ia_marks' . $_POST['ia'] . ' where sem = "' . $_POST['sem'] . '" and branch = "' . $_POST['dept'] . '" order by sub';
  $result = $link->query($q);
  $num_subs = mysqli_num_rows($result);
  $i = ord('D');
  ...
  foreach ($result1 as $r1) {
    ...
    foreach ($result as $r2) {
      // $subtype = 'select * from subjects_new where ';
      // $q_sub_marks = 'select ia' . $_POST["ia"] . ',att_avg from marks where usn = "' . $r1['usn'] . '" and branch = "' . $_POST['dept'] . '" and sub = "' . $r2['sub'] . '"';
      $q_sub_marks = 'select a.ia' . $_POST["ia"] . ', b.att_avg from marks a, attendance_average b where a.usn = "' . $r1['usn'] . '" and a.branch = "' . $_POST['dept'] . '" and a.sub = "' . $r2['sub'] . '" and a.usn = b.usn and a.sub = b.sub';
