...
$q_sec = 'select distinct section from students where semester = "' . $sem . '" and branch = "Computer Science and Engineering-parallel"';
...
$div = substr($div, 0, -2);
// echo $div;
$sheet->getCell('D3')->setValue('Department of Computer Science and Engineering-parallel');
...
$q_students = 'select * from students where semester = "' . $sem . '" and branch = "Computer Science and Engineering-parallel" order by usn';
// echo $q_students;
...
$q_num_lab_exp = 'select * from lab_marks where sub = "' . $sub_name . '" and sem = "' . $sem . '" and branch = "Computer Science and Engineering-parallel" order by usn';
...
// echo $num_exp;
$q_co_map = 'select * from lab_co_mapping where dept = "Computer Science and Engineering-parallel" and subcode = "' . $sub_name . '"';
...
$q_lab = 'select * from lab_marks where sub = "' . $sub_name . '" and branch = "Computer Science and Engineering-parallel" and sem = "' . $sem . '"';
...
$q_feedback = 'select * from feedback_response where branch = "Computer Science and Engineering-parallel" and sem = "' . $sem . '" and sub = "' . $sub_name . '" and feedback_name = "Course End"';
...
if (file_exists('labattainment_Computer Science and Engineering-parallel.xlsx')) {
    unlink('labattainment_Computer Science and Engineering-parallel.xlsx');
}

$writer->save('labattainment_Computer Science and Engineering-parallel.xlsx');
