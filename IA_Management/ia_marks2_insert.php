...
// print_r($b);
foreach($b as $a){
$q4="update ia_marks2 set att=0 where  usn = \""  . $a . "\" and branch = \"" . $branch . "\" and sec = \"" . $sec . "\" and sem = \"" . $sem . "\" and sub = \"" . $sub . "\";";
// echo $a;d
$link->query($q4);
// echo $a;
}
...
{
    $q4="update ia_marks2 set att=1 where  usn = \""  . $d . "\" and branch = \"" . $branch . "\" and sec = \"" . $sec . "\" and sem = \"" . $sem . "\" and sub = \"" . $sub . "\";";
    // echo $q4;
    $link->query($q4); 
}
for($i = 1; $i <= $cc; $i++){
    ...
    $q="update ia_marks2 set 1a=" . $vv[0]  . "
                                    ,1b=" . $vv[1]  . "
                                    ,1c=" . $vv[2]  . "
                                    ,2a=" . $vv[3]  . "
                                    ,2b=" . $vv[4]  . "
