...
foreach ($r as $result) {
    $sub = "UG cordinator";
    $q5 = "SELECT n.usn,n.subj from nodue n,students s where n.usn='" . $result["usn"] .  "'and n.subj='" . $sub . "' and s.section='" . $sec . "'";
    ...
    if (mysqli_num_rows($result6)) {
        ...
        $q4 = "INSERT INTO `nodue`( `usn` ,`name`,`subj`,`due`, `sem`, `sec`) VALUES ('" . $result["usn"] .  "','" . $result["fname"] .  "','" . $cont . "','" . $content . "','" . $sem . "', '" . $sec . "');";
        // echo $q4 . '<br>';
