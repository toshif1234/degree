			...
			if ($k == 0) continue;
				...
				foreach($result1 as $r1)
				{
					...
					if($r1['adm_no']==$r[0] && $r1['usn']==$r[1]&& $r1['branch']==$r[3] && $r1['sem']==$r[4] && $r1['sec']==$r[5] && $r1['sub']==$r[6])
					{
						...
						$q = 'update ia_marks3 set 1a = ' . $vv[0] . ', 1b = ' . $vv[1] . ', 1c = ' . $vv[2] . ', 2a = ' . $vv[3] . ', 2b = ' . $vv[4] . ', 2c = ' . $vv[5] . ', 3a = ' . $vv[6] . ', 3b = ' . $vv[7] . ', 3c = ' . $vv[8] . ', 4a = ' . $vv[9] . ', 4b = ' . $vv[10] . ', 4c = ' . $vv[11] . ', total3 = 0 where adm_no = "' . $r[0] . '" and branch = "' . $r[3] . '" and sem = "' . $r[4] . '" and sec = "' . $r[5] . '" and sub = "' . $r[6] . '"';
						// echo $q;
						$result=$con->query($q);
