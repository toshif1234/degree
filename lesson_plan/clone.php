<?php
    ...
    $q = 'select * from lessonpanl where subid = "' . $_SESSION['subid'] . '" and sem = "' . $_SESSION['sem'] . '" and section = "' . $_SESSION['sec'] . '" and branch = "' . $_POST['branch'] . '"';
    $result = $link->query($q);
    // echo $q;
    $q2 = 'select * from lessonpanl where subid = "' . $_SESSION['subid'] . '" and sem = "' . $_SESSION['sem'] . '" and section = "' . $_POST['sec'] . '" and branch = "' . $_POST['branch'] . '" order by sr_no';
