...
require_once "../config.php";
    ...
    if($open == '1'){
        ...
        $q = 'select * from ia_marks1 a, fac_elec_stud f where a.sem="' . $_SESSION['sem'] . '" and f.usn=a.usn and f.sub="' . $_SESSION['sub'] . '" and f.faculty_name="' . $_SESSION['username'] . '";';
       
    }
    else
    {

        $q = 'select * from ia_marks1 where sub="' . $_SESSION["sub"] . '" and branch="' . $_SESSION["branch"] . '" and sem=' . $_SESSION["sem"] . ' and sec="' . $_SESSION["sec"] . '" order by usn';
    }    
        $result = $link->query($q);
        // echo $q;
        $row = 2;
        ...
        foreach($result as $r){
            ...
            $link->query("update ia_marks1 set 1a = " . $v[6] . ", 1b = " . $v[7] . ", 1c = " . $v[8] .", 2a = " . $v[9] . ", 2b = " . $v[10] . ", 2c = " . $v[11] . ", 3a = " . $v[12] . ", 3b = " . $v[13] . ", 3c = " . $v[14] . ", 4a = " . $v[15] . ", 4b = " . $v[16] . ", 4c = " . $v[17] . " where usn='" . $v[0] . "' and sem=" . $v[3] . " and branch='" . $v[2] . "' and sec='" . $v[4] . "' and sub='" . $v[5] . "';");
