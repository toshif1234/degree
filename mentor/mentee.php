...
?>
                <div class="container">
                  ...
                  //  $que="select * from students s, mentor_mapping m where m.usn=s.usn and  s.batch=\"" . $_POST["batch"] . "\" and s.branch=\"" . $_POST["branch"] . "\" and m.fac_name=\"" . $_SESSION["username"] . "\"";
                        ...
                        $que = "select * from students s,mentor_mapping m, parents_details p, puc_details pu, sslc_details ss where s.usn=m.usn and s.adm_no = ss.adm_no and ss.adm_no = pu.adm_no and pu.adm_no = p.adm_no and s.semester=\"" . $_POST["sem"] . "\" and m.fac_name=\"" . $_POST["elective"] . "\"";
                    ...
                    ?><form action="student_update_details.php" method="POST">
                                <div class="row " style="background: #FFFFFF;border: 1px solid #ECF0FA; box-shadow: 0 2px 4px 0 rgba(7,17,55,0.06);  border-radius: 4px; border-radius: 4px;padding:1.5% ;margin-top: 1%;">
                                    ...
                                    <div class="form-group col-md-3" style="margin-top: .6%;left: 5%;">
                                        ...
                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal2<?php echo $con1 ?>">
                                           IA
                                        </button>
...
//$que1 ="select * from marks k,mentor_mapping m,students s where s.usn=k.usn and  s.usn=m.usn and s.semester=k.sem and m.usn = k.usn and k.usn= \"" .$row["usn"]. "\" and s.batch=\"" . $_POST["batch"] . "\" and s.branch=\"" . $_POST["branch"] . "\" and m.fac_name=\"" . $_SESSION["username"] . "\"";
      $que1 ="select k.external,k.sub,k.ia1,k.ia2,k.ia3,k.att_avg,k.ia_avg,k.total_marks,k.assignment_avg,(k.ia_avg+k.assignment_avg) as tot, (k.ia_avg+k.assignment_avg+k.external) as grand from marks k,mentor_mapping m,students s where s.usn=k.usn and  s.usn=m.usn and s.semester=k.sem and m.usn = k.usn and k.usn= \"" .$row["usn"]. "\"  and m.fac_name=\"" . $_POST["elective"] . "\""; 
    ...
    //  $result2 = $con->query($que2);
     ...
     <div class="modal fade " id="exampleModal2<?php echo $con1 ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
            ...
            <div class="modal-content">
                ...
                <p style="margin-left:30em;colorblack;font: size 25px;"><B>CIE &nbsp;&nbsp&nbsp;&nbsp &nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp &nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp &nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp &nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp &nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp &nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; SIE</B></p>
    ...
    <!-- Metting -->
    <?PHP
      $que2 ="select * from shedule m,mentor_mapping k,students s where s.usn=m.usn and k.usn=m.usn and k.usn= \"" .$row["usn"]. "\" and s.semester=\"" . $_POST["sem"] . "\" and  k.fac_name=\"" . $_POST["elective"] . "\"";
                        $result2 = $con->query($que2);
                        // echo $que2;
    ?>


<div class="modal fade " id="exampleModal3<?php echo $con1 ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" width=70%  aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                            ...
                            <div class="row">
                                <div class="col col-12 col-md-12 col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="sslc_percentage" class="form-control" id="sslc_percentage" value="<?php if((float)$row["sslc_percentage"] < 1) echo (float)$row["sslc_percentage"]*100 . "%"; else echo $row["sslc_percentage"] . "%" ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col col-12 col-md-12 col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="puc_percentage" class="form-control" id="puc_percentage" value="<?php if((float)$row["puc_percentage"] < 1) echo (float)$row["puc_percentage"]*100 . "%"; else echo $row["puc_percentage"] . "%" ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
