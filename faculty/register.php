      ...
      <span aria-hidden="true">&times;</span>
                ...
                <div class="wrapper container p-4 m-3">
                    ...
                    <form action="auto_gen.php" method="POST">
                        <button style="float:right; display:flex;" onclick="loader()" type="submit" class="btn btn-primary m-5">Auto Generate</button>
                        <input type="password" value="aiet123" name="password" class="form-control" hidden>
                    </form>
