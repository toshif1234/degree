 <?php
    ...
    $q1 = "insert into faculty_workshop_details(`faculty_id`,
             `faculty_workshop_name`,
             `faculty_workshop_title`,
             `faculty_workshop_no_of_days`) values (\"" . $_SESSION["faculty_id"] . "\",
    ...
    if ($r = $con->query($q1)) {
        header("Location: ../faculty/faculty_insert.php");
    } else {
