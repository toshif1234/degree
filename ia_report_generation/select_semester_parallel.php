...
<form action="download_con_parallel.php" method="post">
    <div class="form-row">
...
foreach ($result as $r) {
    ...
    <input type="text" name="sem" id="" value="7" hidden>
    </div>
...
foreach ($result as $r) {
    ...
    <input type="text" name="sec" id="" value="C" hidden>
    </div>
    <div class="form-group col-md-4">
    ...
    <div class="form-group col-md-4">
         <input type="text" hidden name="dept" value="Computer Science and Engineering-parallel" id="">
...
<a hidden href="<?php echo '../uploads/ia_report_generated_' . 'Computer Science and Engineering-parallel' . '.xlsx' ?>" download id="down"></a>
<?php
