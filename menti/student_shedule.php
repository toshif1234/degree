...
$BATCH = "SELECT batch FROM `students` WHERE usn='" . $val . "'";
$BRANCH = "SELECT branch FROM `students` WHERE usn='" . $val . "'";


//$q = 'select * from students where semester = "' . $_SESSION['sem'] . '" and section = "' . $_SESSION['sec'] . '" and  order by usn';
//  echo $q;
$q = "select * from students s,mentor_mapping m where s.usn=m.usn  and batch=\"" . $BATCH . "\" and branch=\"" . $BRANCH . "\" and m.fac_name=\"" . $_SESSION["username"] . "\"";
